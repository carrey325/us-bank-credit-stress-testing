...
- Mapped CRE recoveries: `RIAD3589` 117→118, `RIADC894` 31→320, `RIADC896` 0→0, and `RIADC898` 257→998, yielding 1,031.
- Mapped closed-end Mortgage recoveries: `RIADC217` 7→307 and `RIADC218` 2→3, yielding 301.
- The mapped subtotal is therefore 1,332, or $89 thousand above the reported total. No total- or mapped-flow YTD decrease occurred in this quarter.
